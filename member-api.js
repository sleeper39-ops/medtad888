const MemberAPI = {
    ...
    async redeemGiftVoucher(userId, sessionToken, voucherLink, telegramBotToken, telegramChatId) {
        return this.call('redeemGiftVoucher', { userId, sessionToken, voucherLink, telegramBotToken, telegramChatId });
    }
};
